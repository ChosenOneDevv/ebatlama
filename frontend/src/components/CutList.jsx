...
function CutRow({ cut, index, onUpdate, onDelete, onDuplicate, isEditing, onStartEdit, onCancelEdit }) {
  ...
  return (
    <tr className="hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-0">
      <td className="px-2 py-2 text-center text-gray-400 text-sm font-medium">{index + 1}</td>
      <td className="px-2 py-2">
        {cut.materialColor ? (
          <span 
            className="inline-block w-3 h-3 rounded-full"
      ...
      <td className="px-2 py-2 text-gray-800 text-sm truncate" title={cut.name}>
        {cut.name || '-'}
      </td>
      <td className="px-2 py-2 text-gray-600 text-xs font-mono truncate" title={cut.code}>
        {cut.code || '-'}
      </td>
      <td className="px-2 py-2 font-semibold text-gray-800 whitespace-nowrap">{cut.length} mm</td>
      <td className="px-2 py-2 text-center">
        <span className="inline-flex items-center justify-center min-w-[1.5rem] px-1.5 py-0.5 bg-gray-100 text-gray-700 rounded-full text-xs font-medium">
          {cut.quantity}
        </span>
      </td>
      <td className="px-2 py-2">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              <th className="px-2 py-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider w-8">#</th>
              <th className="px-2 py-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider w-6" title="Malzeme">M</th>
              <th className="px-2 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider min-w-[120px]">Ad</th>
              <th className="px-2 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider min-w-[80px]">Kod</th>
              <th className="px-2 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider w-20">Uzunluk</th>
              <th className="px-2 py-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider w-12">Adet</th>
              <th className="px-2 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider w-16">Baş</th>
              <th className="px-2 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider w-16">Son</th>
              <th className="px-1 py-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider w-20">İşlem</th>
            </tr>
          </thead>
